...
admin=["u90cc967742feb9facc47771907a0ccc2","u90cc967742feb9facc47771907a0ccc2"]
creator=["u90cc967742feb9facc47771907a0ccc2"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Assalamu'alaikum trimakasih sudah Menambahkan Teman
Melayani
VIP Smule Android / Iphone
Koin Line
Bot Protect / Self Bot
Bot Siri
Sewa Room Event
Bot Chat / Bot OA
CLBK monggo (Chat Lama Beli Kagak)
By Panca Shop""",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~arziel91",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
              ...
              if msg.from_ in admin:
				...
				if msg.from_ in admin:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Check dulu ya mas panca.\nLalu ketik Tes buat mengetahui siapa yg ngintip Created By Panca ")
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Selamat datang di Room Kami Semoga Nyaman & Betah yaa..")
					kk.sendText(msg.to,"Jangan nakal ok!")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping","Samlekom","samlekom"]:
				ki.sendText(msg.to,"Setia")
				kk.sendText(msg.to,"Pada")
				kc.sendText(msg.to,"Satu")
#-----------------------------------------------
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == True:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line:://ti/p/~elvenknight")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Smule @USIpanca |Founder USI|")
						print "DiLike"
					except:
							pass
				else:
